...
public final class QueryUtils {
    ...
    public static ArrayList<Track> fetchNewsData(String requestUrl) {
        // Create URL object
        ...
        ArrayList<Track> Character = extractFeatureFromJson(jsonResponse);
    ...
    private static ArrayList<Track> extractFeatureFromJson(String characterJSON) {
